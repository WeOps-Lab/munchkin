...
class BotActionRule(models.Model):
    ...
    channel = models.ForeignKey(Channel, on_delete=models.CASCADE, verbose_name='生效通道', null=True, blank=True)
    rule_user_groups = models.ManyToManyField(ChannelUserGroup, verbose_name='生效用户组', null=True, blank=True)
    rule_user = models.ManyToManyField(ChannelUser, verbose_name='生效用户', null=True, blank=True)
